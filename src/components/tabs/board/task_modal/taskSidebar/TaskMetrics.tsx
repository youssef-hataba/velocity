...
export const TaskMetrics = ({
  ...
  return (
    <div className="space-y-10">
      {/* Progress Card */}
      <div className="p-8 rounded-[2.5rem] bg-linear-to-br from-primary/20 via-primary/5 to-transparent border border-primary/20 relative overflow-hidden">
        ...
        <Sparkles
          size={60}
          className="absolute -right-4 -bottom-4 text-primary/10 rotate-12 pointer-events-none"
        />
      </div>
